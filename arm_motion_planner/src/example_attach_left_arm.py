...
class ArmMotionClient:
    left_group = ['LShoulder_Pitch', 'LShoulder_Roll', 'LElbow_Pitch', 'LElbow_Yaw', 'LWrist_Pitch', 'LWrist_Roll']
    ...
    def plan(self):
        ...
        current_torso = sensor_msgs.msg.JointState(
            name = self.left_group,
            position = [0.0, -0.174532778], #0.174532778
            velocity = [0.0, 0.0],
            effort = [0.0, 0.0],
        )
        ...
        target_ee_pose = geometry_msgs.msg.Pose(
               position=geometry_msgs.msg.Point(0.30, 0.10, 0.95),
