...
class ArmMotionClient:
    ...
    def plan(self):
        ...
        #0.6122799604755981, -0.35350000000000004, 0.6122799604755981, 0.35350000000000004
        #0.614075, -0.357651, 0.612937, 0.345407
        ...
        #     )
        req.target_ee_pose = geometry_msgs.msg.Pose(
                position=geometry_msgs.msg.Point(0.269549625, 0.21774159661, 0.82886),
                orientation=geometry_msgs.msg.Quaternion(
                    0.6122799604755981, -0.35350000000000004, 0.6122799604755981, 0.35350000000000004)
            )
        # constraints
        ...
        req.Obstacles3D = [obs1, obs2, obs3, obs4]
